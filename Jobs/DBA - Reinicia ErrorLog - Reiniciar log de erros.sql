...
/****** Object:  Job [DBA - Reinicia ErrorLog]    Script Date: 03/07/2017 11:01:53 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [DBA]    Script Date: 03/07/2017 11:01:53 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA - Reinicia ErrorLog', 
		@enabled=1, 
		...
		@job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_cycle_errorlog]    Script Date: 03/07/2017 11:01:53 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Diário', 
		...
		@schedule_uid=N'e4f0ebd3-e1bc-4377-9981-f945b3df7a8b'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
